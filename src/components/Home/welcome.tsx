...
function WelcomeCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    <div className="bg-[#fff] m-[15px] rounded-md animate__animated animate__slower animate__zoomIn hover:border-b-4 hover:border-[#ff6f00] transition-shadow duration-300 group relative flex flex-col items-center min-w-[260px] max-w-[320px] flex-1 drop-shadow-[0_0_20px_rgba(0,0,0,0.099)]">
